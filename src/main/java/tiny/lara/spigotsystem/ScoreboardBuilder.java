...
public abstract class ScoreboardBuilder {
    ...
    public ScoreboardBuilder(Player player, String displayName) {
        ...
        if(this.scoreboard.getObjective("Gamessucht.com") != null) {
            this.scoreboard.getObjective("Gamessucht.com").unregister();
        }
        this.objective = this.scoreboard.registerNewObjective("§aGamessucht.com", "dummy");
